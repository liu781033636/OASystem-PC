...
public class DepartmentAction {
	...
	public String del()
	{
		int size=employeeService.findByHql("from Employee where dpt_id="+departmentId).size();
		if (size==0){
...
//		System.out.println("11111111111111111111111111111111111111111");
		...
		else return "department_del_false";
	...
	{   
		//后台验证部门名称、部门类别不能为空
		if(null!=department.getDptName() &&!"".equals(department.getDptName()))
		{
